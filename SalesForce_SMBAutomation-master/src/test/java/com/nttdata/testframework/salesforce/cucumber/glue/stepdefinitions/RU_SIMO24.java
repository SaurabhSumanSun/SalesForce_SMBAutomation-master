...
public class RU_SIMO24 {
    ...
    public void User_logins_as_sales_rep_for_RU_portal() throws Throwable {
        ...
        @Then("^User can add the Upgrade for all RU products by clicking on simo$")
        public void User_can_add_the_Upgrade_for_all_RU_products_by_clicking_on_simo() throws Throwable{
            PageFactory.initElements(driver,RU_SIMO24);
            Buffer proceedHandler;
            RU_SIMO24.toString(RU_SIMO24);
