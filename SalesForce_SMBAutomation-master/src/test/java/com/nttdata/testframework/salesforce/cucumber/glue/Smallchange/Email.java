...
public class Email<TariffPage> {
    ...
    public void Customer_is_able_to_launch_the_businessshop_and_select(String Simo) throws Throwable {
        ...
        pageFactory.initElements((WebDriver) null, Simo.class);
        Simo24.Simo(Simo);
    }
    ...
    public void customer_can_see_the_order_is_successful() throws Throwable{
        Parameter orderpage = null;
        orderpage.order();


    }
    @Then ("^customer can receives the \"([^\"]\"$")
    public void customer_can_receives_the() throws Throwable{
    Email.driver();
