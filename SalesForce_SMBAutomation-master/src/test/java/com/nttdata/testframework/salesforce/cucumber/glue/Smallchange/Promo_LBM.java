...
public class Promo_LBM<LoginPage, opportunityPage, newProductBasket, mobileDDPConfig, BasketPage, DataTable> {
    ...
    public Promo_LBM(CustomWebDriver customWebDriver) {
            this.driver = (WebDriver) customWebDriver.getWebDriver();
        }

        @Given("^User logins in preprod environment as Ben Myres for LBM channel$")
        public void User_logins_in_preprod_environment_as_Ben_Myres_for_LBM_channel() throws Throwable {
            try {
                Loginpage.equals();
        ...
        public void User_configures_all_SMB_Digital_products_in_the_basket_with_the_following_details(String Contract_Term,String Product_PurchaseType,String Service_Template ,String Digital_ProductName ,String Domain,String DISE_AccountNumber,String CSP_Product ,String Microsoft_Admin_Domain) throws InterruptedException, IOException {
            ObjectInputFilter.Config.Promo_LBM(Contract_Term ,Product_PurchaseType ,Service_Template ,Digital_ProductName ,Domain ,DISE_AccountNumber ,CSP_Product ,Microsoft_Admin_Domain);
            CSP_Product= "YES";
            Contract_Term=Term;
            ;
        }
