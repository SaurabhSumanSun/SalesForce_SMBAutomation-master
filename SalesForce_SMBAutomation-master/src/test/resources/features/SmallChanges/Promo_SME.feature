Feature: Feature001
  Scenario Outline: To verify Sales rep is able to perform an E2E
    ...
    Examples:
      ...
      |TC_2 TC_4 TC_137 TC_139 TC_215 TC_216 TC_220 TC_374  |Test              |Test        |Awareness of Needs|New Business| DD/MM/YYY |1Month       |New                 |o365            |Enterprise Multi SKU |4667658           |YES        |Microsoft.onmicrosoft.com|